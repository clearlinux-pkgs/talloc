...
Source0  : https://www.samba.org/ftp/talloc/talloc-2.4.3.tar.gz
...
Requires: talloc-license = %{version}-%{release}
...
%package license
Summary: license components for the talloc package.
Group: Default

%description license
license components for the talloc package.
...
%prep
%setup -q -n talloc-2.4.3
cd %{_builddir}/talloc-2.4.3
%patch -P 1 -p1
pushd ..
cp -a talloc-2.4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749149451
...
export SOURCE_DATE_EPOCH=1749149451
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/talloc
cp %{_builddir}/talloc-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/talloc/f45ee1c765646813b442ca58de72e20a64a7ddba || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
/usr/lib64/libpytalloc-util.cpython-3*-x86-64-linux-gnu.so
/usr/lib64/pkgconfig/pytalloc-util.cpython-3*-x86_64-linux-gnu.pc

%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpytalloc-util.cpython-313-x86-64-linux-gnu.so.2.4.3
/V3/usr/lib64/libtalloc.so.2.4.3
/usr/lib64/libpytalloc-util.cpython-313-x86-64-linux-gnu.so.2
/usr/lib64/libpytalloc-util.cpython-313-x86-64-linux-gnu.so.2.4.3
/usr/lib64/libtalloc.so.2
/usr/lib64/libtalloc.so.2.4.3

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/talloc/f45ee1c765646813b442ca58de72e20a64a7ddba
