...
Source0  : https://www.samba.org/ftp/talloc/talloc-2.4.2.tar.gz
...
%prep
%setup -q -n talloc-2.4.2
cd %{_builddir}/talloc-2.4.2
%patch -P 1 -p1
pushd ..
cp -a talloc-2.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729971915
...
/usr/lib64/libpytalloc-util.cpython-313-x86-64-linux-gnu.so
/usr/lib64/libtalloc.so
/usr/lib64/pkgconfig/pytalloc-util.cpython-313-x86_64-linux-gnu.pc
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpytalloc-util.cpython-313-x86-64-linux-gnu.so.2.4.2
/V3/usr/lib64/libtalloc.so.2.4.2
/usr/lib64/libpytalloc-util.cpython-313-x86-64-linux-gnu.so.2
/usr/lib64/libpytalloc-util.cpython-313-x86-64-linux-gnu.so.2.4.2
/usr/lib64/libtalloc.so.2
/usr/lib64/libtalloc.so.2.4.2
