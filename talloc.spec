...
Source0  : https://www.samba.org/ftp/talloc/talloc-2.1.11.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1515852247
...
/usr/lib64/libpytalloc-util.so.2.1.11
/usr/lib64/libtalloc.so.2
/usr/lib64/libtalloc.so.2.1.11
